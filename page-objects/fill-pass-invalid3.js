module.exports = {
    ...
    elements: {
        fillPassInvalid3: by.xpath("//input[@id='password']")
    },

    performFill: function () {

        var selector = page.fillPassInvalid3.elements.fillPassInvalid3;
        return driver.findElement(selector).sendKeys(shared.id.passinv3);
    }
};
