module.exports = {
    ...
    elements: {
        fillPassInvalid2: by.xpath("//input[@id='password']")
    },

    performFill: function () {

        var selector = page.fillPassInvalid2.elements.fillPassInvalid2;
        return driver.findElement(selector).sendKeys(shared.id.passinv2);
    }
};
