module.exports = {
    ...
    elements: {
        fillEmailInvalid3: by.xpath("//input[@id='username']")
    },

    performFill: function () {

        var selector = page.fillEmailInvalid3.elements.fillEmailInvalid3;
        return driver.findElement(selector).sendKeys(shared.id.emailinv3);
    }
};
